...
There are no active topics yet. When a question is worth investigating before
committing to a design — a protocol shape, a benchmark, an isolation mechanism —
open it here with `/research-start <slug>`.
...
- **Bars before experiments.** The pass/fail criteria are written down before
  ...
  recorded (constitution: Honest Measurement / the working agreement).
